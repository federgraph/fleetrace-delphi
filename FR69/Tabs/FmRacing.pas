...
function TRacingTab.GetIT: Integer;
begin
  result := Main.GuiManager.IT;
end;

procedure TRacingTab.SetIT(const Value: Integer);
begin
...
procedure TRacingTab.AutoSendBtnClick(Sender: TObject);
begin
...
procedure TRacingTab.UpdateAuto;
begin
