...
type
  TScoringBonusPoint = class(TScoringLowPoint)
  public
    constructor Create;
...
constructor TScoringBonusPoint.Create;
begin
  inherited Create;
  FName := 'Bonus Point';
end;

procedure TScoringBonusPoint.ScoreRace(race: TRace;
  ...
  begin
    ...
    begin
      ...
      if (pts = 0) then
        ...
        pts := 100
      else if (pts = 100) then
        pts := 117
      else if (pts = 117) then
        pts := 130
      else if (pts = 130) then
        pts := 140
      else
        pts := pts + 10;
    end
...
function TScoringBonusPoint.GetPenaltyPoints(p: TISAFPenalty;
